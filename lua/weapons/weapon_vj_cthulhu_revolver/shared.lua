...
SWEP.WorldModel					= "models/vj_cthulhu/w_pythonammobox.mdl"
...
SWEP.WorldModel_CustomPositionOrigin = Vector(-3, 11, -8)
...
SWEP.Primary.Sound				= {"vj_cthulhu/weapons/revolver_shot1.wav","vj_cthulhu/weapons/revolver_shot2.wav"}
SWEP.Primary.DistantSound		= {"vj_hlr/hl1_weapon/deagle/desert_eagle_fire_distant_final.wav"}
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_PistolShell1"
SWEP.Primary.TracerType = "VJ_HLR_Tracer"

-- Custom
SWEP.HLR_ValidModels = {"models/vj_cthulhu/ganster_revolver.mdl","models/vj_cthulhu/cultist_revolver.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
