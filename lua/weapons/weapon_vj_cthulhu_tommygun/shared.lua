...
SWEP.WorldModel					= "models/vj_cthulhu/w_tommygun.mdl"
...
SWEP.WorldModel_CustomPositionOrigin = Vector(4, -19, -2)
SWEP.WorldModel_CustomPositionBone = "Bip01 R Hand" -- The bone it will use as the main point
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage				= 8 -- Damage
SWEP.Primary.ClipSize			= 50 -- Max amount of bullets per clip
SWEP.Primary.Ammo				= "smg1" -- Ammo type
SWEP.Primary.Sound				= {"vj_cthulhu/weapons/tommy_shoot1.wav","vj_cthulhu/weapons/tommy_shoot2.wav"}
SWEP.Primary.DistantSound		= {"vj_hlr/hl1_weapon/mp5/hks_distant_new.wav"}
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_PistolShell1"
SWEP.Primary.TracerType = "VJ_HLR_Tracer"

-- Custom
SWEP.HLR_ValidModels = {"models/vj_cthulhu/ganster_tommygun.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
