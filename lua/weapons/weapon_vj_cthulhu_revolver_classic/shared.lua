...
SWEP.NPC_ReloadSound			= {"vj_hlr/hl1_weapon/357/357_reload1"} -- Sounds it plays when the base detects the SNPC playing a reload animation
...
-- Custom
SWEP.HLR_ValidModels = {"models/vj_cthulhu/gangster_revolver_classic.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
