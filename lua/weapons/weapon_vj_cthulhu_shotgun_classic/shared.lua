...
SWEP.NPC_ReloadSound			= {"vj_cthulhu/weapons/revolver_reload1.wav"} -- Sounds it plays when the base detects the SNPC playing a reload animation
SWEP.NPC_CanBePickedUp			= false -- Can this weapon be picked up by NPCs? (Ex: Rebels)
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.MadeForNPCsOnly 			= true -- Is this weapon meant to be for NPCs only?
SWEP.WorldModel					= "models/vj_cthulhu/w_shotgun_classic.mdl"
...
SWEP.WorldModel_CustomPositionAngle = Vector(180, 0, 90)
SWEP.WorldModel_CustomPositionOrigin = Vector(4, -30, -2)
...
SWEP.Primary.Sound				= {"vj_cthulhu/weapons/sbarrel1.wav"}
SWEP.Primary.DistantSound		= {"vj_hlr/hl1_weapon/mp5/hks_distant_new.wav"}
SWEP.PrimaryEffects_ShellType 	= "VJ_Weapon_PistolShell1"
SWEP.Primary.TracerType = "VJ_HLR_Tracer"

-- Custom
SWEP.HLR_ValidModels = {"models/vj_cthulhu/gangster_shotgun_classic.mdl","models/vj_cthulhu/cultist_shotgun.mdl"}
---------------------------------------------------------------------------------------------------------------------------------------------
