...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/yodan.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 145
...
ENT.RangeDistance = 1220 -- This is how far away it can shoot
...
ENT.SoundTbl_OnGrenadeSight = {"vj_cthulhu/yodan/yo_pain1.wav","vj_cthulhu/yodan/yo_pain2.wav","vj_cthulhu/yodan/yo_pain3.wav"}
...
function ENT:CustomRangeAttackCode()
	...
	util.VJ_SphereDamage(self, self, hitpos, 10, 10, DMG_SHOCK, true, false, {Force=90})
end
---------------------------------------------------------------------------------------------------------------------------------------------
