...
if CLIENT then
	local Name = "Gut"
	local LangName = "obj_vj_cthulhu_gut"
...
ENT.Model = {"models/vj_cthulhu/humangib3.mdl","models/vj_cthulhu/humangib11.mdl","models/vj_cthulhu/humangib8.mdl"} -- The models it should spawn with | Picks a random one from the table
