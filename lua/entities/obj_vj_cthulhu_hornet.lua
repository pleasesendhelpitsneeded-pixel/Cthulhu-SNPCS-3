...
if CLIENT then
	local Name = "Hornet"
	local LangName = "obj_vj_cthulhu_hornet"
...
ENT.SoundTbl_OnCollide = {"vj_cthulhu/headlessfatman/ag_buzz1.wav","vj_cthulhu/headlessfatman/ag_buzz2.wav","vj_cthulhu/headlessfatman/ag_buzz3.wav"}
ENT.SoundTbl_Startup = {"vj_cthulhu/headlessfatman/ag_fire1.wav","vj_cthulhu/headlessfatman/ag_fire2.wav","vj_cthulhu/headlessfatman/ag_fire3.wav"}
ENT.IdleSoundPitch = VJ_Set(100, 100)

local sdIdle = {}
local sdCollideAlpha = {}
...
---------------------------------------------------------------------------------------------------------------------------------------------
local colorRed = Color(128,128,0)
local colorOrange = Color(85,107,47)
--
