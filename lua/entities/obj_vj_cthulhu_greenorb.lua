...
ENT.PrintName		= "Green orb"
ENT.Author 			= "DrVrej"
ENT.Contact 		= "http://steamcommunity.com/groups/vrejgaming"
ENT.Information		= "Projectiles for my addons"
ENT.Category		= "Projectiles"

ENT.VJ_IsDetectableDanger = false

if CLIENT then
	local Name = "Serpent Man"
	local LangName = "obj_vj_cthulhu_greenorb"
...
function ENT:CustomOnInitialize()
	...
	self.StartGlow1:SetKeyValue("model","vj_cthulhu/sprites/greenorb.vmt")
	...
	self.StartGlow1:SetKeyValue("scale","0.1")
