...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/huntinghorror.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 200
ENT.HullType = HULL_HUMAN
ENT.MovementType = VJ_MOVETYPE_AERIAL
ENT.Aerial_AnimTbl_Calm = {"fly1","fly2"} -- Animations it plays when it's wandering around while idle
ENT.Aerial_AnimTbl_Alerted = {"fly2","fly1"} -- Animations it plays when it's moving while alerted
...
ENT.SoundTbl_Idle = {"vj_cthulhu/hhorror/hh_idle1.wav","vj_cthulhu/hhorror/hh_idle2.wav","vj_cthulhu/hhorror/hh_idle3.wav"}
ENT.SoundTbl_Alert = {"vj_cthulhu/hhorror/hh_alert1.wav","vj_cthulhu/hhorror/hh_alert2.wav","vj_cthulhu/hhorror/hh_alert3.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"vj_cthulhu/hhorror/hh_attack1.wav","vj_cthulhu/hhorror/hh_attack2.wav","vj_cthulhu/hhorror/hh_attack3.wav"}
...
ENT.SoundTbl_Pain = {"vj_cthulhu/hhorror/hh_pain1.wav","vj_cthulhu/hhorror/hh_pain2.wav","vj_cthulhu/hhorror/hh_pain3.wav"}
ENT.SoundTbl_Death = {"vj_cthulhu/hhorror/hh_die1.wav","vj_cthulhu/hhorror/hh_die2.wav","vj_cthulhu/hhorror/hh_die3.wav"}
...
function ENT:CustomOnThink()	
	if self.Security_CanHurtWalk && self:Health() <= (self:GetMaxHealth() / 2.0) then
self.Aerial_FlyingSpeed_Calm = 1200 
self.Aerial_FlyingSpeed_Alerted = 1200
	end	
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------------------
local gibsgreen = {"models/vj_cthulhu/snakegib1.mdl","models/vj_cthulhu/snakegib2.mdl","models/vj_cthulhu/snakegib3.mdl","models/vj_cthulhu/snakegib1.mdl"}
