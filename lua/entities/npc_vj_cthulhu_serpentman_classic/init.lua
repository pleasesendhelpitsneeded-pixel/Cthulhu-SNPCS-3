...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/serpentman_classic.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 75
...
function ENT:Tor_CreateAlly()
	...
	local ally = ents.Create("npc_vj_cthulhu_snakeclassic")
