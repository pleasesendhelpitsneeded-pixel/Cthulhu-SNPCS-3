...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/ghoul_classic.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 120
...
ENT.SoundTbl_Idle = {"vj_cthulhu/ghoul/gh_idle1.wav","vj_cthulhu/ghoul/gh_idle2.wav","vj_cthulhu/ghoul/gh_idle3.wav"}
ENT.SoundTbl_Alert = {"vj_cthulhu/ghoul/gh_alert1.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"vj_cthulhu/ghoul/gh_attack1.wav"}
ENT.SoundTbl_MeleeAttackExtra = {"vj_hlr/hl1_npc/zombie/claw_strike1.wav","vj_hlr/hl1_npc/zombie/claw_strike2.wav","vj_hlr/hl1_npc/zombie/claw_strike3.wav"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_hlr/hl1_npc/zombie/claw_miss1.wav","vj_hlr/hl1_npc/zombie/claw_miss2.wav"}
ENT.SoundTbl_Pain = {"vj_cthulhu/ghoul/gh_pain1.wav"}
ENT.SoundTbl_Death = {"vj_cthulhu/ghoul/gh_pain1.wav"}
...
function ENT:CustomOnInitialize()
	self:SetCollisionBounds(Vector(10, 10, 48), Vector(-10, -10, 0))
end
---------------------------------------------------------------------------------------------------------------------------------------------
