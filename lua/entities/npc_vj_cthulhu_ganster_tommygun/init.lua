...
ENT.Model = {"models/vj_cthulhu/ganster_tommygun.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 100
...
function ENT:Security_CustomOnInitialize()
	...
	self:Give("weapon_vj_cthulhu_tommygun")
end
---------------------------------------------------------------------------------------------------------------------------------------------
