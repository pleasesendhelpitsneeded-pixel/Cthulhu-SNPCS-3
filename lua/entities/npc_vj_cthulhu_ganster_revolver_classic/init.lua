...
ENT.Model = {"models/vj_cthulhu/gangster_revolver_classic.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 100
...
---------------------------------------------------------------------------------------------------------------------------------------------
ENT.VJ_NPC_Class = {"CLASS_GANSTER"} -- NPCs with the same class with be allied to each other
...
function ENT:Security_CustomOnInitialize()
	self.SoundTbl_Idle = {"vj_cthulhu/gangster/ga_idle1.wav","vj_cthulhu/gangster/ga_idle2.wav","vj_cthulhu/gangster/ga_idle3.wav","vj_cthulhu/gangster/ga_idle4.wav"}
	self.SoundTbl_IdleDialogue = {"vj_cthulhu/gangster/ga_quest1.wav","vj_cthulhu/gangster/ga_quest2.wav"}
	self.SoundTbl_IdleDialogueAnswer = {"vj_cthulhu/gangster/ga_answer1.wav","vj_cthulhu/gangster/ga_answer2.wav"}
	self.SoundTbl_CombatIdle = {"vj_cthulhu/gangster/ga_charge1.wav","vj_cthulhu/gangster/ga_charge2.wav","vj_cthulhu/gangster/ga_charge3.wav"}
	self.SoundTbl_FollowPlayer = {}
	self.SoundTbl_UnFollowPlayer = {}
	self.SoundTbl_OnPlayerSight = {}
	self.SoundTbl_Investigate = {"vj_cthulhu/gangster/ga_check1.wav","vj_cthulhu/gangster/ga_check2.wav"}
	self.SoundTbl_Alert = {"vj_cthulhu/gangster/ga_alert1.wav","vj_cthulhu/gangster/ga_alert2.wav"}
	self.SoundTbl_CallForHelp = {}
	self.SoundTbl_BecomeEnemyToPlayer = {}
	self.SoundTbl_Suppressing = {}
	self.SoundTbl_OnGrenadeSight = {"vj_cthulhu/gangster/ga_gren1.wav","vj_cthulhu/gangster/ga_gren2.wav"}
	self.SoundTbl_OnDangerSight = {"vj_cthulhu/gangster/ga_cover1.wav","vj_cthulhu/gangster/ga_cover2.wav"}
	self.SoundTbl_OnKilledEnemy = {"vj_cthulhu/gangster/ga_clear1.wav","vj_cthulhu/gangster/ga_clear2.wav"}
	...
	self:Give("weapon_vj_cthulhu_revolver_classic")
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnInitialize()
	local randrace = math.random(1,3)
	if randrace == 1 then self:SetBodygroup(0,0) end
	if randrace == 2 then self:SetBodygroup(0,1) end
	if randrace == 3 then self:SetBodygroup(0,2) end
...
function ENT:CustomOnAcceptInput(key, activator, caller, data)
	...
	elseif key == "body" then
		VJ_EmitSound(self, "vj_hlr/fx/bodydrop"..math.random(3, 4)..".wav", 75, 100)	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
