...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/nightgaunt.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 100
ENT.HullType = HULL_HUMAN
ENT.MovementType = VJ_MOVETYPE_AERIAL
ENT.Aerial_AnimTbl_Calm = {"flying_cycler_1","flying_cycler_2"} -- Animations it plays when it's wandering around while idle
ENT.Aerial_AnimTbl_Alerted = {"flying_cycler_1","flying_cycler_2"} -- Animations it plays when it's moving while alerted
...
ENT.Aerial_FlyingSpeed_Alerted = 250 -- The speed it should fly with, when it's chasing an enemy, moving away quickly, etc. | Basically running compared to ground SNPCs
ENT.VJC_Data = {
...
ENT.AnimTbl_Death = {"death_fall_simple","death_fall_violent"}
	-- ====== Flinching Variables ====== --
...
ENT.SoundTbl_Idle = {}
ENT.SoundTbl_Alert = {"vj_cthulhu/nightgaunt/ng_alert1.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"vj_cthulhu/nightgaunt/ng_attack1.wav"}
...
ENT.SoundTbl_Pain = {"vj_cthulhu/nightgaunt/ng_pain2.wav","vj_cthulhu/nightgaunt/ng_pain3.wav"}
ENT.SoundTbl_Death = {"vj_cthulhu/nightgaunt/ng_die1.wav","vj_cthulhu/nightgaunt/ng_die2.wav"}
...
function ENT:CustomOnThink()	
	if self.Security_CanHurtWalk && self:Health() <= (self:GetMaxHealth() / 4.2) then
