...
ENT.Model = {"models/vj_cthulhu/formlessspawn_old.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 150
...
function ENT:CustomOnDeath_AfterCorpseSpawned(dmginfo, hitgroup, corpseEnt)
	...
	timer.Simple(math.random(5,12), function()
		if IsValid(corpseEnt) then
			local Evolution = ents.Create("npc_vj_cthulhu_humanoid_formless_spawn")
