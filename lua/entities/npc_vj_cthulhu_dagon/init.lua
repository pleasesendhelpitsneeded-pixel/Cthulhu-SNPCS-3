...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/dagon.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
ENT.SoundTbl_Idle = {"vj_cthulhu/deepone/do_idle1.wav","vj_cthulhu/deepone/do_idle2.wav"}
ENT.SoundTbl_Alert = {"vj_cthulhu/deepone/do_alert1.wav","vj_cthulhu/deepone/do_alert2.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"vj_cthulhu/deepone/do_attack1.wav","vj_cthulhu/deepone/do_attack2.wav"}
...
ENT.SoundTbl_Pain = {"vj_cthulhu/deepone/do_pain1.wav","vj_cthulhu/deepone/do_pain2.wav"}
ENT.SoundTbl_Death = {"vj_cthulhu/deepone/do_pain1.wav","vj_cthulhu/deepone/do_pain2.wav"}
...
function ENT:CustomOnInitialize()
	...
	timer.Simple(0.0,function() if IsValid(self) then self:VJ_ACT_PLAYACTIVITY("bigflinch", true, false, false) end end)
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:CustomOnAcceptInput(key, activator, caller, data)
	...
	elseif key == "body" then
		VJ_EmitSound(self, {"vj_cthulhu/common/bodydrop1.wav","vj_cthulhu/common/bodydrop2.wav","vj_cthulhu/common/bodydrop3.wav","vj_cthulhu/common/bodydrop4.wav"}, 100, 80)
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
