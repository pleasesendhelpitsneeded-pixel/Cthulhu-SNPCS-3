...
-----------------------------------------------*/
ENT.Model = {"models/vj_cthulhu/deepone.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 140
...
function ENT:CustomGibOnDeathSounds(dmginfo, hitgroup)
	...
	VJ_EmitSound(self, {"vj_cthulhu/deepone/do_pain1.wav","vj_cthulhu/deepone/do_pain2.wav"}, 90, 100)	return false
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnDeath_AfterCorpseSpawned(dmginfo, hitgroup, corpseEnt)
	...
	timer.Simple(math.random(5,12), function()
		if IsValid(corpseEnt) then
			local Evolution = ents.Create("npc_vj_cthulhu_deepone")
			...
			if Evolution.EvolveNow == true then
				VJ_EmitSound(Evolution, {}, 100, math.random(100, 80))
	               ...
	               local ReviveAnim = VJ_PICK({"getup"})
